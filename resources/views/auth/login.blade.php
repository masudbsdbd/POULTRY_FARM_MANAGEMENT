                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <input class="form-control" type="text" id="usernameInput" value="{{ old('username') }}"
                                name="username" required placeholder="@lang('Username')">
                        </div> --}}
                        ...
                        <!-- <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <div class="input-group-text" data-password="true" onclick="togglePassword()">
                    ...
                    <!-- Footer-->
                     <br>
                    <div >
                        <p class="text-muted">Don't have an account? <a href="{{ route('register.form') }}" class="text-muted ms-1"><b>Sign
                                    Up</b></a></p>
                    </div>
                </div> <!-- end .card-body -->
            </div> <!-- end .card -->
