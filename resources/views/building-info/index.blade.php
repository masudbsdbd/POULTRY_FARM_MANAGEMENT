                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <button type="button"
                                        ...
                                        data-route="{{ route('building.store', $building->id) }}"><i class="mdi mdi-grease-pencil"></i></button>
                                    ...
                                    @if($building->floor->isEmpty())
                                        <button type="button"
                                            ...
                                            data-action="{{ route('building.delete', $building->id) }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form class="px-3" action="{{ route('building.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="catename" class="form-label">Building Name</label>
