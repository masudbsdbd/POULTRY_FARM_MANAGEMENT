...
<div class="container-fluid">
    ...
    @include('layouts.shared.page-title', ['title' => 'Brands', 'subtitle' => 'Products'])
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        @can('brand-create')
                        <button type="button" class="mb-2 btn btn-primary waves-effect waves-light mb-2 createCatBtn">Add
                            New</button>
                        @endcan
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @php
                                    $productCount = $item->product->count();
                                    @endphp
                                ...
                                <td class="text-end">
                                    ...
                                    <button type="button"
                                        ...
                                        data-route="{{ route('brand.store', $item->id) }}"><i
                                    ...
                                    <button type="button"
                                        ...
                                        data-action="{{ route('brand.delete', $item->id) }}"><i
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form class="px-3" action="{{ route('brand.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="catename" class="form-label">Brand Name</label>
                        <input class="form-control" type="text" id="catename" name="name" required
                            placeholder="Brand Name">
                    </div>
                    <div class="mb-3 d-flex">
                        <label for="createbrandstatus">Status</label>
                        <label class="switch m-0">
                            <input id="createbrandstatus" checked type="checkbox" class="toggle-switch" name="status">
        ...
        <div class="modal-content">
            ...
            <form id="editForm" class="px-3" action="" method="POST">
                ...
                <div class="mb-3 d-flex">
                    ...
                    <label class="switch m-0">
                        <input id="status" type="checkbox" class="toggle-switch" name="editbrandstatus">
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="mb-3 text-end">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        (function($) {
            ...
            $('.editCatBtn').on('click', function() {
                ...
                if (data.status == 1) {
                    modal.find('input[name="editbrandstatus"]').prop('checked', true);
                }

                if (data.status == 0) {
                    modal.find('input[name="editbrandstatus"]').prop('checked', false);
                }
                modal.modal('show');
            });
        })(jQuery);
