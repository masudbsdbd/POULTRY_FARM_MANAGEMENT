...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title', ['title' => 'Withdraw Amount', 'subtitle' => 'Bank'])
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form action="{{ route('bank.transaction.store') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="balance" class="form-label">Withdraw Amount</label>
                                        <div class="input-group">
                                            <input type="number" id="balance" class="form-control"
                                                placeholder="Withdraw Amount" name="withdraw_amount">
                                            <div class="input-group-text" data-password="false">Tk
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="simpleinput" class="form-label">Bank Account No</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="withdrawer_name" class="form-control" name="withdrawer_name"
                                            placeholder="Withdrawer Name" required>
                                    </div>
