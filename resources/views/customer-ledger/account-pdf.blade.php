            ...
            <tr>
                ...
                <td class="details-cell">
                    <div class="supplier-details">
                        ...
                        <p><span class="value">{{ !empty($customerData->company) ? $customerData->company : '-' }}</span>
                        </p>
                        <p><span class="value">{{ !empty($customerData->mobile) ? $customerData->mobile : '-' }}</span>
                        </p>
                        <p><span class="value">{{ !empty($customerData->address) ? $customerData->address : '-' }}</span>
                        </p>
                        <p><span class="value">{{ !empty($customerData->email) ? $customerData->email : '-' }}</span></p>
