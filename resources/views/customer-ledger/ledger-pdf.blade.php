            ...
            <tr>
                ...
                <td class="details-cell">
                    <div class="supplier-details">
                        ...
                        <p><span class="value">{{ !empty($customerData->name) ? $customerData->name : '-' }}
                                ({{ !empty($customerData->code) ? $customerData->code : '-' }})</span></p>
                        <p><span
                                class="value">{{ !empty($customerData->company) ? $customerData->company : '-' }}</span>
                        </p>
                        <p><span class="value">{{ !empty($customerData->mobile) ? $customerData->mobile : '-' }}</span>
                        </p>
                        <p><span
                                class="value">{{ !empty($customerData->address) ? $customerData->address : '-' }}</span>
                        </p>
                        <p><span class="value">{{ !empty($customerData->email) ? $customerData->email : '-' }}</span>
                        </p>
                        <p class="advance"><span class="label">Advance:</span> <span
                                class="value">{{ !empty(showAmount($customerData->advance)) ? showAmount($customerData->advance) : '-' }}</span>
                        </p>
                    </div>
                </td>
            ...
            <tbody>
                ...
                @foreach ($sells as $item)
                    @php
                        ...
                        $totalMainPrice += $item['discount'] + $item['total_price'];
                    ...
                    <tr>
                        ...
                        <td>{{ showAmount($item->discount + $item->total_price) }}  </td>
