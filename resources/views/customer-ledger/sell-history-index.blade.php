...
<div class="container-fluid">
    ...
    @include('layouts.shared.page-title', ['title' => 'Sell History', 'subtitle' => 'All Customers'])
                ...
                <div class="card-body">
                    ...
                    <div class="border rounded p-3 mb-3 bg-light">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ !empty(showAmount($customerData->advance)) ? showAmount($customerData->advance) : '-' }} Tk
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="button-list mb-2">
                        <!-- <div>
                            ...
                            <a href="{{ route('customer.ledger.account.index',$id) }}" class="btn btn-blue waves-effect waves-light">Accounts Ledger
                            </a>
                            <a href="{{ route('customer.ledger.sell.index',$id) }}" class="btn btn-primary waves-effect waves-light">Sell History
                            </a>
                        </div> -->
                        <form action="{{ route('customer.ledger.sell.index',$id) }}" method="get" id="myForm">
                    ...
                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ showAmount($item->discount + $item->total_price) }} </td>
                        ...
                        <tfoot>
                            <tr style="font-size: 16px;">
                                ...
                                <td class="text-center"><strong>{{ $totalPrice + $totalDiscount }} Tk</strong></td>
