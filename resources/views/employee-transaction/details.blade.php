                            ...
                            <tbody>
                                @foreach ($transactions as $item)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <button data-paragraph="{{ $item->description }}" href="javascript:void(0)"
                                                class="btn btn-primary descBtn" href="">
                                            ...
                                            <button title="Delete" type="button"
                                                ...
                                                data-action="{{ route('employee.transaction.delete', $item->id) }}"><i
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ showAmount(getEmpTrSum('received_amount', $employee->id, false, $date)) }}
                                        Tk</td>
                                    <td class="text-center">
                                        {{ showAmount(getEmpTrSum('punishment', $employee->id, false, $date)) }} Tk
                                    </td>
                                    <td></td>
                                </tr>
                            </tbody>
