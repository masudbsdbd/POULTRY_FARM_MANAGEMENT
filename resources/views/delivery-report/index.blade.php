        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('delivery.report.index') }}" method="get">
                        <div class="row">
                            <!-- Start Date Field -->
                            <div class="col-md-2">
                    ...
                    <div class="mt-3">
                        <table id="basic-datatables" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ showAmount($item->sell->total_price) }} Tk</td>
                                    <td class="text-center">{{ $item->sell->total_qty }}</td>
                                    <td class="text-end">
                                        <button title="View" type="button"
                                            class="btn btn-primary waves-effect waves-light sellDetailBtn"
                                            data-records="{{ $item->sell->sellRecords }}"
                                            data-cusotmerName="{{ $item->sell->customer->name }}"><i
                                                class="mdi mdi-eye"></i></button>
                                    </td>
                                </tr>
                                @php
                                $totalPrice += $item->sell->total_price;
                                $totalQty += $item->sell->total_qty;
                                @endphp
                                @endforeach
                            </tbody>
                        ...
                        <div class="d-flex justify-content-end mt-3">{{ $deliveries->links() }}</div>
                    </div>
                </div>
            </div>
        </div>
