...
<div class="container-fluid">
    ...
    @include('layouts.shared.page-title', ['title' => 'Categories', 'subtitle' => 'Products'])
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <button type="button"
                                        ...
                                        data-action="{{ route('category.delete', $item->id) }}"><i
                ...
                <form class="px-3" action="{{ route('category.store') }}" method="POST">
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <label class="switch m-0">
                            <input id="createcatstatus" type="checkbox" checked class="toggle-switch" name="status">
