            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                @foreach ($types as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @php
                                                $customerCount = $item->customers->count();
                                            @endphp
                                            {{ $customerCount }}
                                        ...
                                        <td class="text-end">
                                            ...
                                            <button type="button"
                                                ...
                                                data-route="{{ route('setting.customer.type.store', $item->id) }}"><i
                                            ...
                                            <button type="button"
                                                ...
                                                data-action="{{ route('setting.customer.type.delete', $item->id) }}"><i
                        ...
                        <div class="d-flex justify-content-end mt-3">{{ $types->links() }}</div>
                    </div> <!-- end card body-->
                </div> <!-- end card -->
            </div><!-- end col-->
        </div>
                    ...
                    <form class="px-3" action="{{ route('setting.customer.type.store') }}" method="POST">
                        ...
                        <div class="mb-3 d-flex">
                            ...
                            <label class="switch m-0">
                                <input id="createcatstatus" type="checkbox" class="toggle-switch" name="status" checked>
