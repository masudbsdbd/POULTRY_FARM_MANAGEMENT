                        ...
                        <div class="col-lg-12">
                            <form
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="example-trn_number" class="form-label">TRN Number</label>
                                            <input type="text" id="example-trn_number" class="form-control" name="trn_number"
                                                placeholder="TRN Number" required
                                                value="{{ old('name', isset($customer) ? $customer->trn_number : '') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="example-trn_date" class="form-label">TRN Date</label>
                                            <input type="date" id="example-trn_date" class="form-control" name="trn_date"
                                                placeholder="TRN Date"
                                                value="{{ old('name', isset($customer) ? $customer->trn_date : '') }}">
                                        </div>
                                    </div>
                                </div>
