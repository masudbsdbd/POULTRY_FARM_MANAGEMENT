        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Total Debit (Tk)</th>
                    <th class="text-center">Total Credit (Tk)</th>
            ...
            <tbody>
                @foreach ($receivables as $item)
                    <tr>
                        ...
                        <td class="text-center">{{ showAmount($item->total_debit) }}</td>
                        <td class="text-center">{{ showAmount($item->total_credit) }}</td>
