...
<div class="container-fluid">
    ...
    @include('layouts.shared.page-title', ['title' => 'Product', 'subtitle' => 'Product'])
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('expense.head.create') }}" class="mb-2 btn btn-primary waves-effect waves-light">Add
                            New</a>
                        @endcan
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    @can('expense-head-edit')
                                    <a href="{{ route('expense.head.edit', $item->id) }}"
                                    ...
                                    <button type="button"
                                        ...
                                        data-question="@lang('Are you sure to delete this Expense Head?')"
                                        data-action="{{ route('expense.head.delete', $item->id) }}"><i
                    ...
                    <div class="d-flex justify-content-end mt-3">{{ $expenseHeads->links() }}</div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content shadow-lg">
            <div class="modal-header text-white">
                <h5 class="modal-title">Expense Head Details</h5>
