                                                    ...
                                                    <div class="thumb">
                                                        <div class="avatar-preview" style="height: 290px;">
                                                            <div class="profilePicPreview"
                                                                style="height: 290px; background-image: url({{ isset($invoiceInfo) ? (isset($invoiceInfo->diagram_image) ? asset('uploads/invoices/' . $invoiceInfo->diagram_image) : asset('uploads/default-picker.png')) : asset('uploads/default-picker.png') }}); background-size: cover; background-position: center; background-repeat: no-repeat;">
                                                    ...
                                                    @php
                                                        ...
                                                        $nnnn = App\Models\QuotationItem::with(['product'])
                                                            ...
                                                            ->each(function ($item) use ($tempQuotId) {
                                                                ...
                                                                $approvalItems = App\Models\approval_items::with('floor.building')
                                                                    ->where('product_id', $item->product_id)
