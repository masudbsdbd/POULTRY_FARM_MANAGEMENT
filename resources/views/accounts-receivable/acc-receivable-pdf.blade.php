        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    {{-- <th class="text-center">Supplier Advance Amount (TK)</th> --}}
                    <th class="text-center">Receivable Amount (TK)</th>
                </tr>
            </thead>
            <tbody>
                @php
                ...
                @endphp
                    <tr>
                        ...
                        <td class="text-center">{{ $item->sell && $item->sell->customer ? $item->sell->customer->name : '---' }}</td>
                        ...
                        {{-- <td class="text-center">{{ showAmount($item->supplier_advance_amount) }} </td> --}}
                        <td class="text-center">{{ showAmount($item->receivable_amount) }} </td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
