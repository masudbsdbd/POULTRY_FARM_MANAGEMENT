...
<div class="container-fluid">
    ...
    @include('layouts.shared.page-title', ['title' => 'Investor Create', 'subtitle' => 'Investor'])
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="{{ isset($investors) ? route('investor.store', $investors->id) : route('investor.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="name"
                                        type="text" class="form-control" placeholder="Investor Name"
                                        name="name" required value="{{ old('name', isset($investors) ? $investors->name : '') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="example-email" name="email" class="form-control"
                                        placeholder="Email"
                                        value="{{ old('name', isset($investors) ? $investors->email : '') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="example-mobile" class="form-control" name="mobile"
                                        ...
                                        value="{{ old('name', isset($investors) ? $investors->mobile : '') }}">
                                </div>
                            ...
                            <div class="mb-3">
                                    <label for="account_no" class="form-label">Address</label>
                                    <textarea name="address" id="" cols="30" rows="5" class=" form-control">{{ old('address', isset($investors) ? $investors->address : '') }}</textarea>
                                </div>
                                ...
                                <div class="text-end">
                                    <button type="submit" class="btn btn-primary waves-effect waves-light">
                                        ...
                                        {{ isset($supplier) ? 'Update Investor' : 'Add New Investor' }}
                                    </button>
                                </div>
                            </form>
                        </div> <!-- end col -->
