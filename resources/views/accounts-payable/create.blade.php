...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title', ['title' => 'Create Payable', 'subtitle' => 'Payable'])
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form action="{{ route('accounts.payable.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="mb-3">
                                                <label for="simpleinput" class="form-label">Payable Amount</label>
                                                <input type="number" id="simpleinput" class="form-control"
                                                    placeholder="Payable Amount" name="payable_amount" step="any" required>
                                            </div>
                                        </div>
                                    </div>
