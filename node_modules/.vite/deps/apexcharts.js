  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var E = function() {
      function t2(e2, i2) {
        a(this, t2), this.ctx = e2, this.w = e2.w;
        var s2 = this.w;
        this.barOptions = s2.config.plotOptions.bar, this.isHorizontal = this.barOptions.horizontal, this.strokeWidth = s2.config.stroke.width, this.isNullValue = false, this.isRangeBar = s2.globals.seriesRangeBar.length && this.isHorizontal, this.xyRatios = i2, null !== this.xyRatios && (this.xRatio = i2.xRatio, this.initialXRatio = i2.initialXRatio, this.yRatio = i2.yRatio, this.invertedXRatio = i2.invertedXRatio, this.invertedYRatio = i2.invertedYRatio, this.baseLineY = i2.baseLineY, this.baseLineInvertedY = i2.baseLineInvertedY), this.yaxisIndex = 0, this.seriesLen = 0, this.barHelpers = new X(this);
      }
    ...
    var H = function() {
      ...
      return r(t2, [{ key: "init", value: function(t3) {
        ...
        var a2 = new R(i2), s2 = ("bar" === t3 || "boxPlot" === t3) && i2.plotOptions && i2.plotOptions.bar && i2.plotOptions.bar.horizontal, r2 = "pie" === t3 || "polarArea" === t3 || "donut" === t3 || "radar" === t3 || "radialBar" === t3 || "heatmap" === t3, o2 = "datetime" !== i2.xaxis.type && "numeric" !== i2.xaxis.type, n2 = i2.xaxis.tickPlacement ? i2.xaxis.tickPlacement : e2.xaxis && e2.xaxis.tickPlacement;
    ...
    var V = function() {
      ...
      return r(t2, [{ key: "scaleSvgNode", value: function(t3, e2) {
        ...
        if (!p.isIE11()) return t3.replace(/&nbsp;/g, "&#160;");
    ...
    var j = function() {
      ...
      return r(t2, [{ key: "niceScale", value: function(t3, e2) {
        ...
        for (var a2 = [], s2 = Math.ceil(Math.log(e2) / Math.log(i2)) + 1, r2 = 0; r2 < s2; r2++) a2.push(Math.pow(i2, r2));
        ...
        if (r2.logarithmic && o2 <= 5 && (a2.invalidLogScale = true), r2.logarithmic && o2 > 5) a2.allSeriesCollapsed = false, a2.yAxisScale[t3] = this.logarithmicScale(e2, i2, r2.logBase);
      ...
      return r(t2, [{ key: "getElTooltip", value: function(t3) {
        ...
        if (o2) {
          if (i2.tooltipRect = { x: 0, y: 0, ttWidth: o2.getBoundingClientRect().width, ttHeight: o2.getBoundingClientRect().height }, i2.e = s2, i2.tooltipUtil.hasBars() && !r2.globals.comboCharts && !i2.isBarShared) {
            if (this.tConfig.onDatasetHover.highlightDataSeries) new z(e2).toggleSeriesOnHover(s2, s2.target.parentNode);
          }
    ...
    var mt = function(t2) {
      ...
      return r(s2, [{ key: "draw", value: function(t3, i3) {
        ...
        void 0 === this.series[h2][c2] || null === this.series[h2][c2] ? (v2 = r2, m2 = r2) : (v2 = r2 + v2 / g2, m2 = r2 + m2 / g2, f2 = r2 + p2.h / g2, x2 = r2 + p2.l / g2, y2 = r2 + p2.m / g2);
      ...
      return r(t2, [{ key: "_updateOptions", value: function(t3) {
        ...
        return new Promise(function(n2) {
          ...
          r2 && (l2 = e2.ctx.getSyncedCharts()), e2.ctx.w.globals.isExecCalled && (l2 = [e2.ctx], e2.ctx.w.globals.isExecCalled = false), l2.forEach(function(r3, h2) {
            var c2 = r3.w;
            return c2.globals.shouldAnimate = s2, a2 || (c2.globals.resized = true, c2.globals.dataChanged = true, s2 && r3.series.getPreviousPaths()), t3 && "object" === i(t3) && (r3.config = new H(t3), t3 = y.extendArrayProps(r3.config, t3, c2), r3.w.globals.chartID !== e2.ctx.w.globals.chartID && delete t3.series, c2.config = p.extend(c2.config, t3), o2 && (c2.globals.lastXAxis = t3.xaxis ? p.clone(t3.xaxis) : [], c2.globals.lastYAxis = t3.yaxis ? p.clone(t3.yaxis) : [], c2.globals.initialConfig = p.extend({}, c2.config), c2.globals.initialSeries = p.clone(c2.config.series))), r3.update(t3).then(function() {
        ...
        return new Promise(function(s2) {
          ...
          })).length && (r2 = [{ data: [] }]), o2.config.series = r2) : o2.config.series = t3.slice(), a2 && (o2.globals.initialSeries = p.clone(o2.config.series)), i2.ctx.update().then(function() {
            s2(i2.ctx);
          });
        });
